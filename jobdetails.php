...
?>
    ...
    <div class="jobdetails_container">
        <div class="jobdetails_child1"><div class="company-name">
    ...
    <div class="buttons">
    <button class="button" onclick="this.innerHTML = 'Applied!!';">
  Apply
    </div>
        ...
        <div class="section">
            <div>
                ...
                <div class="section-content">
                    <p>
                    <?php echo $fetch_job['jobDescription']; ?>
                        </p>
                </div>
            </div>
        </div>
        ...
        <div class="section">
            ...
            <ul>
    <?php 
    // Check if $fetch_job['jobrequirement'] is a string and not an array
    if (is_string($fetch_job['jobrequirement'])) {
        ...
        // Loop through the array and display each requirement
        foreach($requirements as $requirement) {
            // Ensure each requirement is displayed on a new line
